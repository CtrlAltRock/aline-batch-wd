...
@Slf4j
public class UserInsufficientBalanceMore extends BasicWriter<BigDecimal> implements InTransitAnalysis<UserDTO>, PostProcessAnalysis {

    double hasInsufficent = 0.0;

    public UserInsufficientBalanceMore(BigDecimal input) {
        super(input);
    ...
    public String filePath() {
        return "/Users/willemduiker/IdeaProjects/aline-batch-wd/src/main/resources/analysis/Percent_Of_Users_With_Insufficient_Balance_More_Than_Once.xml";
    }
